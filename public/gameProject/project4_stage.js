...
lib.ssMetadata = [
		{name:"project4_stage_atlas_1", frames: [[0,1282,154,239],[312,1282,154,228],[156,1282,154,239],[468,1282,154,228],[0,0,1920,1280]]}
];
...
(lib.CachedBmp_4 = function() {
	this.initialize(ss["project4_stage_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.project4_stage = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/project4_stage_atlas_1.png", id:"project4_stage_atlas_1"}
	],
	preloads: []
};
